...
echo '2745600 2745600 2745600 3033600 3033600' > /proc/sys/walt/cluster0/smart_freq/ipc_freq_levels
echo '4070400 4070400 4262400 4262400 4396800' > /proc/sys/walt/cluster1/smart_freq/ipc_freq_levels
