...
echo '2400000 2745600 2918400 2918400 2918400' > /proc/sys/walt/cluster0/smart_freq/ipc_freq_levels
echo '3801600 4089600 4089600 4089600 4089600' > /proc/sys/walt/cluster1/smart_freq/ipc_freq_levels
